...
displayed_file = ScrolledText(tab2,height=15)# Initial was Text(tab2)
...
# Display Screen For Result
url_display = ScrolledText(tab3,height=15)
url_display.grid(row=7,column=0, columnspan=3,padx=5,pady=5)


tab3_display_text = ScrolledText(tab3,height=15)
...
entry1=ScrolledText(tab4,height=15)
